...
This is the basic example from [_Introduction to simmer_](https://cran.r-project.org/web/packages/simmer/vignettes/A-introduction.html). Please, refer to that vignette for further detail.
